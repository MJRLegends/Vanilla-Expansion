...
public class TreeWorldGenerator implements IWorldGenerator {
	...
	private void generateSurface(World world, Random random, int chunkX, int chunkZ) {
		...
		for (int k = 0; k < treesPerChunk; k++) {
			...
			if (b == BiomeGenBase.river || b == BiomeGenBase.forest || b == BiomeGenBase.plains || b == BiomeGenBase.forestHills
					|| b == BiomeGenBase.extremeHills || b == BiomeGenBase.extremeHillsEdge || b == BiomeGenBase.extremeHillsPlus) {
